 ...
 */
final class Version20200409091437 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users ADD roles JSON NOT NULL, CHANGE date_delete date_delete DATETIME DEFAULT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE users DROP roles, CHANGE date_delete date_delete DATETIME DEFAULT \'NULL\'');
    }
}
