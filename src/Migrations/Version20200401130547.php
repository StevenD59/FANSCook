 ...
 */
final class Version20200401130547 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notes CHANGE users_id users_id INT DEFAULT NULL, CHANGE recettes_id recettes_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE preparations CHANGE date_delete date_delete DATETIME DEFAULT NULL');
        $this->addSql('ALTER TABLE recettes ADD descriptions LONGTEXT NOT NULL, CHANGE date_delete date_delete DATETIME DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE notes CHANGE users_id users_id INT DEFAULT NULL, CHANGE recettes_id recettes_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE preparations CHANGE date_delete date_delete DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE recettes DROP descriptions, CHANGE date_delete date_delete DATETIME DEFAULT \'NULL\'');
        $this->addSql('ALTER TABLE users CHANGE date_delete date_delete DATETIME DEFAULT \'NULL\'');
    }
}
